...
export default function SocialFormUpdate({userSocialsInfo}) {
  const { toast } = useToast();
  const [socialLinks, setSocialLinks] = useState(userSocialsInfo);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-[#f7f7f7] border border-white/50 dark:bg-[#15191a] dark:border-[#282F30]/40 p-8 rounded-[2rem] mt-8 flex flex-col gap-6">
