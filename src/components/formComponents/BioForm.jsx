...
export function ProfileForm() {
  ...
  const [websiteNameCharCount, setWebsiteNameCharCount] = useState(0);
    ...
    if (Object.values(data).some((value) => value.trim() !== "")) {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          toast({
            title: "Your submitted values have been saved successfully",
          });
        }
      } catch (error) {
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormLabel className="flex gap-2 items-center">
                Website Name
                <InfoTooltip info={"Choose a stylish website name that reflects you"} />
              </FormLabel>

              <span className="text-gray-400">{websiteNameCharCount}/20</span>
              </div>
              <FormControl>
                <Input
                  placeholder="Batman"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormLabel className="flex gap-2 items-center">
                Username
                <InfoTooltip info={"Integrate it as your name or nickname"} />
              </FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="flex gap-2 items-center">
                Profession
                <InfoTooltip info={"Ensure it clearly communicates your expertise"} />
              </FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormLabel className="flex gap-2 items-center">
                Bio
                <InfoTooltip info={"Craft it into your about content as well."} />
              </FormLabel>
