...
const schema = z.object({
  ...
  profession: z.string().min(1, "Profession should be a one character").optional(),
...
const UserProfile = ({ userData }) => {
  ...
  return (
    <div className="bg-[#f7f7f7] border border-white/50 dark:bg-[#15191a] dark:border-[#282F30]/40 p-8 rounded-[2rem] md:w-[70%] w-[95%]">
      <div className="space-y-1 flex items-end gap-2.5">
      ...
      <div className="flex justify-between items-center">
        <div className="flex flex-wrap h-5 items-center space-x-2">
